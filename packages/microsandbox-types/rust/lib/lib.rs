...
pub use domain::{
    ...
    HandoffInit, HostPattern, HostPermissions, HttpProxyConfig, HttpProxyConfigPatch,
    ...
    OutboundProxy, Patch, PlacementProfile, PortProtocol, PortRange, Protocol, PublishedPortSpec,
    PullPolicy, RateLimitConfigError, RateLimiterConfig, Rlimit, RlimitResource, RootDisk,
    RootfsSource, Rule, SandboxConfigPatch, SandboxLogLevel, SandboxPolicy, SandboxPolicyPatch,
    ...
    SecretInjection, SecretsConfig, SecretsConfigPatch, SecurityProfile, SnapshotSpec,
    ...
    VsockRouteSpec, VsockSocketType, VsockSpec, VsockSpecPatch, canonicalize_volume_mounts,
};
