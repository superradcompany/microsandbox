...
use crate::{
    ...
    CloudSandboxStatus, CloudSecretEntry, CloudSecretSource, CloudSecretsConfig,
    CloudViolationAction, CloudVolumeMount, ConfigPlannedChange, Destination, DestinationGroup,
    Direction, DiskImageFormat, DnsConfig, EnvVar, HandoffInit, HostPattern, HostPermissions,
    InterceptCaConfig, InterfaceOverrides, LogSource, ModificationConflict,
    ...
    SecretPlannedChange, SecretSource, SecretsConfig, SecurityProfile, SnapshotDestination,
...
pub fn declarations() -> Vec<String> {
    ...
    vec![
        ...
        // Moved network/secrets model (referenced by the now-typed NetworkSpec).
