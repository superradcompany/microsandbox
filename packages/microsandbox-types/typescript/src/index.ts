...
export type DestinationGroup = "public" | "loopback" | "private" | "link-local" | "metadata" | "multicast" | "host";

export type Destination = "any" | { "cidr": string } | { "domain": string } | { "domain-suffix": string } | { "group": DestinationGroup };
