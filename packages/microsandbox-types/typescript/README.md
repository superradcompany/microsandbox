...
- `CloudCreateSnapshotRequest` and `CloudSnapshot` are flat unions discriminated by the current `kind: "disk"`; common snapshot fields stay flat beside the discriminator.
