...
impl SandboxHandle {
    ...
    pub async fn connect(&self) -> MicrosandboxResult<Sandbox> {
        ...
        // The relay is supposed to be running already for a sandbox in
        // Running/Draining state; if it doesn't respond within the default
        // 10s, something is wedged and the caller should see a timeout
