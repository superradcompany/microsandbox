...
/// [`Self::from_config`].
pub(in crate::engine::dns) struct NormalizedDnsConfig {
    pub(in crate::engine::dns) rebind_protection: bool,
    ...
    pub(in crate::engine::dns) nameservers: Vec<Nameserver>,
    /// Per-query timeout.
    pub(in crate::engine::dns) query_timeout: Duration,
}
...
impl NormalizedDnsConfig {
    ...
    pub(in crate::engine::dns) fn from_config(config: DnsConfig) -> Self {
        Self {
