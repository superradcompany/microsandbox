...
/// Install a sandbox alias as a command in ~/.microsandbox/bin.
#[derive(Debug, Args)]
pub struct InstallArgs {
    ...
    /// Alias name. Defaults to the image basename.
    #[arg(short, long)]
    ...
    /// Ephemeral mode (no state persisted between invocations).
    #[arg(long)]
    pub tmp: bool,
