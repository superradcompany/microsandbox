---
title: Microsandbox SDK overview for Rust, TS, and Python
description: Install the embeddable microsandbox SDK and create your first sandbox in Rust, TypeScript, or Python. No daemon needed - the SDK spawns the VM directly.
icon: "play"
---
