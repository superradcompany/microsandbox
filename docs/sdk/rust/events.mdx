---
title: Rust SDK events API reference (preview)
description: Reference for sending and receiving host-guest events from the Rust SDK. Includes a preview of the planned API and a note on current availability.
