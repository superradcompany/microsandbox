---
title: "Rust SDK execution API: exec, stream, shell"
description: Reference for running commands inside a sandbox from Rust. Covers exec, exec_stream, shell, ExecOutput, ExecHandle, and async stream iteration patterns.
icon: "terminal"
---
