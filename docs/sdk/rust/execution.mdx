---
title: Execution
"og:title": Rust SDK Execution reference
description: Run commands in a microVM sandbox with the Rust SDK. Stream output, send input, and inspect exit results.
