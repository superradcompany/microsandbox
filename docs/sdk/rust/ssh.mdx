---
title: SSH
"og:title": Rust SDK SSH reference
description: Open sandbox SSH sessions and transfer files over SFTP with the Rust SDK.
keywords: ["Rust SDK", "Rust ssh", "microsandbox ssh"]
---

Requires the `ssh` feature. See [SSH](/sandboxes/ssh) for client sessions, server endpoints, and file transfer workflows.
