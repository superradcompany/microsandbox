---
title: Rust SDK Secret type for credential injection
description: Reference for the Rust Secret::env builder. Inject API keys and credentials into a sandbox using placeholder substitution at the TLS proxy with allow lists.
icon: "key"
---
