...
#### <span className="msb-recv">secret.</span><span className="msb-hn">allow_placeholder_for()</span>
...
<p className="msb-backref">Used by <a href="#secretentry">SecretEntry</a> · <a href="#secret-allow">allow()</a> · <a href="#secret-allow_placeholder_for">allow_placeholder_for()</a></p>
