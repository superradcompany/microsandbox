---
title: Secrets
"og:title": Rust SDK Secrets reference
description: Configure host-side secret substitution with the Rust SDK. Set allowed destinations, placeholder passthrough, and violation policies.
