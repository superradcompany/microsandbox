...
<div className="msb-glance">
  ...
  <p className="msb-gl"><span className="msb-dot builder"></span>Builder · SandboxBuilder<span className="msb-ct">35</span></p>
  ...
  <div className="msb-chiprow">
    ...
    <a className="msb-typepill" href="#registryconfigbuilder">RegistryConfigBuilder</a>
