---
title: Rust SDK Sandbox struct API reference
description: Reference for Sandbox::builder, create, get, start, stop, exec, and config in the Rust SDK. The full Sandbox API for booting and managing microsandbox VMs.
icon: "cube"
---
