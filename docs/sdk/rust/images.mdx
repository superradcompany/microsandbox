...
<div className="msb-glance">
  ...
  <p className="msb-gl"><span className="msb-dot static"></span>Ambient cache methods<span className="msb-ct">5</span></p>
  ...
  <p className="msb-gl"><span className="msb-dot static"></span>Explicit local variants<span className="msb-ct">5</span></p>
