---
title: Images
"og:title": Rust SDK Images reference
description: Inspect and manage the local OCI image cache with the Rust SDK.
keywords: ["Rust SDK", "Rust images", "microsandbox images"]
---
...
<p className="msb-backref">Returned by <a href="#imageget">get()</a> · <a href="#imagelist">list()</a></p>
...
<p className="msb-backref">Returned by <a href="#imageinspect">inspect()</a></p>
...
<p className="msb-backref">Returned by <a href="#imageprune">prune()</a></p>

Summary of cached image data removed by [`Image::prune()`](#imageprune).
...
<p className="msb-backref">Used by <a href="#imagesave">save()</a></p>

Archive layout to write when exporting images with [`Image::save()`](#imagesave).
