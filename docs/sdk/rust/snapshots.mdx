---
title: "Rust SDK Snapshot API: save and restore disks"
description: Reference for the Rust Snapshot and SnapshotHandle types. Save a stopped sandbox's disk as a portable artifact and boot fresh sandboxes from it.
icon: "camera"
---
