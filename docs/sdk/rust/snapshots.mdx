---
title: Snapshots
"og:title": Rust SDK Snapshots reference
description: Create and restore microVM snapshots with the Rust SDK. Save disk state, or capture memory and running processes locally.
