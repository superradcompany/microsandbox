...
Limit the maximum number of concurrent network connections from the sandbox. By default, no connection-count cap is requested. Passing zero also removes the requested cap.
