---
title: Rust SDK networking, policy, DNS, and TLS
description: Reference for the Rust Network type. Configure egress policy presets, port mappings, deny rules, DNS overrides, and TLS interception from Rust applications.
icon: "network-wired"
---
