---
title: Filesystem
"og:title": Rust SDK Filesystem reference
description: Read, write, and stream files inside a running microVM sandbox with the Rust SDK.
keywords: ["Rust SDK", "Rust filesystem", "microsandbox filesystem"]
---
...
<Tooltip tip="Open-handle filesystem operations require a live local relay client. Use the path-based methods on microsandbox cloud."><span className="msb-badge-local">Local-only <Icon icon="circle-info" size={11} /></span></Tooltip>
