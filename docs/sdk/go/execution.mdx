...
description: Run sandbox commands and stream their output with the Go SDK.
keywords: ["Go SDK", "Go execution", "microsandbox execution"]
---

Non-zero exit codes are returned in [`ExecOutput`](#execoutput), not as Go errors. See [Commands](/sandboxes/commands) for usage examples.
