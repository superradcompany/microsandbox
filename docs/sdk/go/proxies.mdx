---
title: Proxies
"og:title": Go SDK Proxies reference
description: Route outbound sandbox connections through a SOCKS4 or SOCKS5 proxy with the Go SDK.
---

Set the proxy with [`WithProxy`](#m-withproxy). SOCKS4 and SOCKS5 are mutually exclusive. See [Outbound proxies](/networking/outbound-proxy) for setup examples.
