...
Boot from a snapshot artifact by bare name, artifact directory, or archive file. Mutually exclusive with [`WithImage`](#withimage). See [Snapshots](/sdk/go/snapshots).
...
<div className="msb-params">
  <div className="msb-param">
    ...
    <div className="msb-param-desc">Snapshot bare name, artifact directory, or archive file.</div>
  </div>
</div>
