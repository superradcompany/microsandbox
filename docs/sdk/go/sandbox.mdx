...
#### <span className="msb-recv"></span><span className="msb-hn">WithDiskSize()</span>
<div className="msb-tags"><span className="msb-tag is-builder">option</span></div>
...
Set the writable disk size for an OCI image, in MiB. Valid only with an OCI image rootfs, not disk images or snapshots.
...
| DiskSizeMiB | `uint32` | Writable disk size for OCI image roots |
