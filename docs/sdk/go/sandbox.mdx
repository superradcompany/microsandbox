...
See [Runtime setup](/sdk/setup#resolve-check-install-and-ensure) for runtime installation and verification helpers. See [Inspect Go versions](/sdk/setup#inspect-go-versions) for the Go-only version helpers.
...
See [Runtime setup](/sdk/setup#customize-installation) for the setup-only `InstallOptions` type.
