---
title: Secrets
"og:title": Go SDK Secrets reference
description: Configure host-side secret substitution with the Go SDK. Set allowed destinations, placeholder passthrough, and violation policies.
