...
Factory namespace for [`SecretEntry`](#secretentry) values. Invoke through the package-level `Secret` value.
...
```go
microsandbox.Secret.Env("STRIPE_KEY", os.Getenv("STRIPE_KEY"),
    microsandbox.SecretEnvOptions{
