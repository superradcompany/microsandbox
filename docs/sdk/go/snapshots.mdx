---
title: Snapshots
"og:title": Go SDK Snapshots reference
description: Create and restore microVM snapshots with the Go SDK. Save disk state, or capture memory and running processes locally.
