...
| Compaction | `SnapshotCompaction` | Flat-snapshot compaction: `SnapshotCompactionOff` (default), `SnapshotCompactionAuto` (best effort), or `SnapshotCompactionOn` (required) |
