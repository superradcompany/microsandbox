...
<div className="msb-params">
  ...
  <div className="msb-param">
    ...
    <div className="msb-param-desc">Destination directory, group, labels, force, compaction, and root disk size.</div>
  </div>
</div>
...
Configures [`Snapshot.Clone`](#snapshot-clone). All fields are optional; a zero value clones into the default snapshots directory without compacting or resizing.
