...
|--------|---------|-------------|
| `Rule.AllowDNS()` | [`PolicyRule`](#policyrule) | Allow gateway DNS over UDP and TCP port 53 |
| `Rule.DenyDNS()` | [`PolicyRule`](#policyrule) | Deny gateway DNS over UDP and TCP port 53 |
