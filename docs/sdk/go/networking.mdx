...
| HTTPDenyMessage | `string` | Body for the `403 Forbidden` the gateway returns on denied HTTP/HTTPS. `{host}` is substituted. Empty uses the default agent-facing message |
