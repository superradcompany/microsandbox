---
title: VSock
"og:title": Python SDK VSock reference
description: Connect a sandbox to host Unix sockets or local Windows named pipes over virtio-vsock with the Python SDK.
---
