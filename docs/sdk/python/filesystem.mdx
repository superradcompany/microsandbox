---
title: Filesystem
"og:title": Python SDK Filesystem reference
description: Read, write, and stream files inside a running microVM sandbox with the Python SDK.
keywords: ["Python SDK", "Python filesystem", "microsandbox filesystem"]
---
