---
title: "Python SDK filesystem API: read, write, copy"
description: Reference for the Python SandboxFs API. Read, write, copy, list, and stream files between host and guest, including bulk transfers and directory walks.
icon: "folder-open"
---
