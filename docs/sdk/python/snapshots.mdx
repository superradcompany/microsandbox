...
<div className="msb-params">
  ...
  <div className="msb-param">
    <div className="msb-param-key"><code>compaction</code><span className="msb-type">Literal["off", "auto", "on"]</span></div>
    <div className="msb-param-desc">Flat-snapshot free-space compaction. <code>"off"</code> is the default, <code>"auto"</code> is best effort, and <code>"on"</code> requires compaction to succeed.</div>
  </div>
  <div className="msb-param">
