---
title: Snapshots
"og:title": Python SDK Snapshots reference
description: Create and restore microVM snapshots with the Python SDK. Save disk state, or capture memory and running processes locally.
