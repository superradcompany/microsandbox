...
<Note>
  `list_dir`, `reindex`, `save`/`save_to`, `copy_to`, `load`, and `verify` keep the same
...
<div className="msb-params">
  ...
  <div className="msb-param">
    <div className="msb-param-key"><code>from_snapshot</code><span className="msb-type">str | os.PathLike | Snapshot | SnapshotHandle | None</span></div>
