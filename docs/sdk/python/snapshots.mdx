...
<div className="msb-params">
  ...
  <div className="msb-param">
    <div className="msb-param-key"><code>compaction</code><span className="msb-type">Literal["off", "auto", "on"] | None</span></div>
    <div className="msb-param-desc">Flat-snapshot free-space compaction. <code>None</code> inherits <code>snapshot_defaults.compaction</code> (built-in <code>"off"</code>); explicit values are <code>"off"</code>, <code>"auto"</code>, and <code>"on"</code>.</div>
  </div>
  <div className="msb-param">
