---
title: "Python SDK execution API: exec, stream, shell"
description: Reference for running commands in a sandbox from Python. Covers exec, exec_stream, shell, ExecOutput, ExecHandle, and async iteration over stream events.
icon: "terminal"
---
