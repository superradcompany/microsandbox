---
title: Execution
"og:title": Python SDK Execution reference
description: Run commands in a microVM sandbox with the Python SDK. Stream output, send input, and inspect exit results.
...
|---|---|---|
| <span id="rlimit-resource"></span>`resource` | [`RlimitResource`](#rlimitresource) | Which resource is limited |
| <span id="rlimit-soft"></span>`soft` | `int` | Soft limit |
| <span id="rlimit-hard"></span>`hard` | `int` | Hard limit |
