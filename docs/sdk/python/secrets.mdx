...
| `"passthrough"` | Forward matching hosts with the placeholder unchanged; use the configured fallback for non-matching hosts. |
...
ViolationPolicy.passthrough(
    ...
    fallback=ViolationAction.BLOCK_AND_LOG,
)
```
