---
title: Secrets
"og:title": Python SDK Secrets reference
description: Configure host-side secret substitution with the Python SDK. Set allowed destinations, placeholder passthrough, and violation policies.
