---
title: Python SDK Secret class for credential injection
description: Reference for Secret.env in the Python SDK. Inject API keys and credentials into a sandbox using placeholder substitution at the TLS proxy with allow lists.
icon: "key"
---
