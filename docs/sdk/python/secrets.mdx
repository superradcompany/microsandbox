...
| passthrough_hosts | `Sequence[str]` | `()` | Hosts allowed to receive the placeholder unchanged. Does not enable substitution. |
| passthrough_host_patterns | `Sequence[str]` | `()` | Wildcard host patterns allowed to receive the placeholder unchanged. Does not enable substitution. |
...
| passthrough_hosts | `tuple[str, ...]` | Hosts allowed to receive the placeholder unchanged |
| passthrough_host_patterns | `tuple[str, ...]` | Wildcard patterns allowed to receive the placeholder unchanged |
