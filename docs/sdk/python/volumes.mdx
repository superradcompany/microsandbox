...
<div className="msb-params">
  ...
  <div className="msb-param">
    <div className="msb-param-key"><code>deny</code><span className="msb-type">list[str] | None</span></div>
    <div className="msb-param-desc">Host-side deny-list of gitignore-style patterns. Matching entries are hidden from the guest and writes to them are forbidden. Bind mounts only.</div>
  </div>
</div>
...
| deny | `list[str] \| None` | `None` | Host-side deny-list of gitignore-style patterns. Matching entries are hidden from the guest and writes to them are forbidden. Bind mounts only. |
