...
<Tooltip tip="Available for cloud default and managed directory volumes."><span className="msb-badge-note">Available on cloud <Icon icon="circle-info" size={11} /></span></Tooltip>
