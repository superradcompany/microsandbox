...
<div className="msb-params">
  ...
  <div className="msb-param">
    <div className="msb-param-key"><code>root_disk</code><span className="msb-type">RootDiskConfig | dict | int | None</span></div>
...
|---------|---------|-------------|
| `managed(size_mib=None)` | [`RootDiskConfig`](#rootdiskconfig) | Microsandbox-managed sparse ext4 disk |
| `tmpfs(size_mib=None)` | [`RootDiskConfig`](#rootdiskconfig) | Ephemeral RAM-backed upper layer |
| `disk(path, *, format=None, fstype=None)` | [`RootDiskConfig`](#rootdiskconfig) | User-supplied writable disk image |
...
| Value | Description |
|-------|-------------|
| `"docker"` | Docker archive compatible with `docker load` |
...
| `"bind"` | Host directory bind source |
| `"disk"` | Host disk-image source |
...
| Value | Description |
|-------|-------------|
| `"managed"` | Microsandbox-managed sparse ext4 disk |
| `"tmpfs"` | Ephemeral RAM-backed upper layer |
| `"disk-image"` | User-supplied writable disk image |
