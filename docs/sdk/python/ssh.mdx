---
title: SSH
"og:title": Python SDK SSH reference
description: Open sandbox SSH sessions and transfer files over SFTP with the Python SDK.
keywords: ["Python SDK", "Python ssh", "microsandbox ssh"]
---
...
#### <span className="msb-recv">sftp.</span><span className="msb-hn">remove_file()</span>
...
#### <span className="msb-recv">sftp.</span><span className="msb-hn">remove_dir()</span>
...
#### <span className="msb-recv">sftp.</span><span className="msb-hn">real_path()</span>
...
#### <span className="msb-recv">sftp.</span><span className="msb-hn">read_link()</span>
