...
| Method | Returns | Description |
|--------|---------|-------------|
| `NetworkPolicy.none()` | `NetworkPolicy` | Deny all ingress and egress traffic |
| `NetworkPolicy.allow_all()` | `NetworkPolicy` | Allow all ingress and egress traffic |
| `NetworkPolicy.from_profiles(profiles)` | `NetworkPolicy` | Compose the selected canonical network profiles |
