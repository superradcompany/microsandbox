...
| modify(...) | `Awaitable[`[`SandboxModificationPlan`](#sandboxmodificationplan)`]` | Plan or apply a configuration change; same kwargs as [`modify()`](#sb-modify). Does not start stopped sandboxes; changes persist for the next boot |
