...
| init | `str \| dict \|` [`InitConfig`](#initconfig) | Hand off PID 1 to a guest init binary. See [Init handoff](/sandboxes/customization#init-handoff) and [`InitConfig`](#initconfig) for accepted shapes |
...
| user | `str` | - | Default guest user |
| entrypoint | `list[str]` | - | Override image entrypoint |
| init | `str \| dict \|` [`InitConfig`](#initconfig) | - | Hand off PID 1 to a guest init binary. See [Init handoff](/sandboxes/customization#init-handoff) |
