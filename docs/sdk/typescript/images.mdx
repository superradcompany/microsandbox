---
title: Images
"og:title": TypeScript SDK Images reference
description: Inspect and manage the local OCI image cache with the TypeScript SDK.
keywords: ["TypeScript SDK", "TypeScript images", "microsandbox images"]
---
