---
title: TypeScript SDK Sandbox class API reference
description: Reference for Sandbox.create, get, start, stop, exec, and config in the TypeScript SDK. The full Sandbox class API for booting and managing microsandbox VMs.
icon: "cube"
---
