...
#### <span className="msb-recv">network.</span><span className="msb-hn">httpDenyMessage()</span>
...
<div className="msb-params">
  <div className="msb-param">
    <div className="msb-param-key"><code>message</code><span className="msb-type">string</span></div>
    <div className="msb-param-desc">Plain-text body template; <code>{"{host}"}</code> is substituted.</div>
  </div>
</div>
...
| httpDenyMessage | `string \| null` | Body for `403 Forbidden` on denied HTTP/HTTPS; `null` uses the default |
