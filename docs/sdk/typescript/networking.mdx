---
title: TypeScript SDK networking, policy, DNS, and TLS
description: Reference for the TypeScript Network class. Configure egress policy presets, port mappings, deny rules, DNS overrides, and TLS interception from Node or Bun.
icon: "network-wired"
---
