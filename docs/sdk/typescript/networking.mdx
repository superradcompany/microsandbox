---
title: Networking
"og:title": TypeScript SDK Networking reference
description: Configure sandbox network policies, DNS, TLS interception, and published ports with the TypeScript SDK.
...
Set the sandbox-wide blocking action. Passthrough hosts are configured per secret with `allowPassthroughFor()`.
