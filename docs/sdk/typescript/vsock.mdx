---
title: VSock
"og:title": TypeScript SDK VSock reference
description: Connect a sandbox to host Unix sockets or local Windows named pipes over virtio-vsock with the TypeScript SDK.
---

Expose a host Unix socket or local Windows named pipe to a sandbox over virtio-vsock. See [Host sockets](/networking/host-sockets) for guest connection details, platform support, and security considerations.
