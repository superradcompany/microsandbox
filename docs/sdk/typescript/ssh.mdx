---
title: SSH
"og:title": TypeScript SDK SSH reference
description: Open sandbox SSH sessions and transfer files over SFTP with the TypeScript SDK.
keywords: ["TypeScript SDK", "TypeScript ssh", "microsandbox ssh"]
---
