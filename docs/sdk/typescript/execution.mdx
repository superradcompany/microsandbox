---
title: "TypeScript SDK execution: exec, stream, shell"
description: Reference for running commands in a sandbox from TypeScript. Covers exec, execStream, execStreamWithConfig, ExecOutput, ExecHandle, and async iteration.
icon: "terminal"
---
