---
title: Proxies
"og:title": TypeScript SDK Proxies reference
description: Route outbound sandbox connections through a SOCKS4 or SOCKS5 proxy with the TypeScript SDK.
---

Set the proxy with [`SandboxBuilder.proxy()`](#proxy). SOCKS4 and SOCKS5 are mutually exclusive. See [Outbound proxies](/networking/outbound-proxy) for setup examples.
