---
title: TypeScript SDK Secret API for credential injection
description: Reference for Secret.env in the TypeScript SDK. Inject API keys and credentials into a sandbox using placeholder substitution at the TLS proxy with allow lists.
icon: "key"
---
