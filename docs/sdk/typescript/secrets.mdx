---
title: Secrets
"og:title": TypeScript SDK Secrets reference
description: Configure host-side secret substitution with the TypeScript SDK. Set allowed destinations, placeholder passthrough, and violation policies.
