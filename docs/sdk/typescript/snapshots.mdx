---
title: "TypeScript SDK Snapshot API: save and restore disks"
description: Reference for the TypeScript Snapshot and SnapshotHandle classes. Save a stopped sandbox's disk as a portable artifact and boot fresh sandboxes from it.
icon: "camera"
---
