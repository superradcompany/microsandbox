---
title: Filesystem
"og:title": TypeScript SDK Filesystem reference
description: Read, write, and stream files inside a running microVM sandbox with the TypeScript SDK.
keywords: ["TypeScript SDK", "TypeScript filesystem", "microsandbox filesystem"]
---
