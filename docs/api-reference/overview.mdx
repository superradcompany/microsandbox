---
title: Overview
"og:title": Microsandbox cloud REST API reference
description: Authenticate cloud REST API requests with API keys or personal tokens, and handle errors and pagination.
