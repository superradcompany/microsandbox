---
title: "Introductie"
description: "Elke agent verdient zijn eigen computer"
icon: "house"
---
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="bolt" href="/nl/getting-started/quickstart">
    Get a sandbox running in under 5 minutes
  </Card>

  <Card title="Sandbox overview" icon="box" href="/nl/sandboxes/overview">
    Configuration, rootfs sources, and lifecycle
  </Card>

  <Card title="CLI reference" icon="square-terminal" href="/nl/cli/overview">
    Manage sandboxes from the terminal
  </Card>

  <Card title="SDK reference" icon="code" href="/nl/sdk/rust">
