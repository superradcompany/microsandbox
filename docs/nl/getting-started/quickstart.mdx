---
title: "Snelstart"
description: "Krijg een sandbox draaiend in minder dan 5 minuten"
icon: "bolt"
---
...
- [Understand sandbox configuration](/nl/sandboxes/overview): how the VM, filesystem, and networking fit together
- [Run commands and stream output](/nl/sandboxes/commands): `exec`, `shell`, `attach`, and streaming
- [Control network access](/nl/networking/overview): policies, DNS interception, and secret protection
- [Manage sandboxes with the CLI](/nl/cli/overview): create, inspect, and manage sandboxes from the terminal
