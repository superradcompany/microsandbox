---
title: "Sandboxcommando's"
description: "Beheer sandboxes vanaf de terminal"
icon: "cube"
---
...
| `--init` | Hand off PID 1 to this init binary (absolute path) inside the guest after agentd's setup. See [Custom init system](/nl/sandboxes/customize#custom-init-system) |
