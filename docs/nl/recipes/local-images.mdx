---
title: "Lokale images"
description: "Lokale containerimages bouwen en gebruiken"
icon: "boxes-stacked"
---
...
<Tip>
  For persistent configuration that applies to all CLI and SDK operations, add the registry to `~/.microsandbox/config.json` instead. See [Registry TLS](/nl/images/overview#registry-tls).
</Tip>
