---
title: "Docker"
description: "Voer Docker-containers uit binnen microsandbox"
icon: "box"
---


<Tip>
  For production use, we recommend [installing microsandbox natively](/nl/getting-started/quickstart).
</Tip>
