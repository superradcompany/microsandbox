---
title: "Aanpassen"
description: "Pas de gastomgeving aan met scripts en patches"
...
- Rust: [`PatchBuilder`](/nl/sdk/rust/sandbox#patchbuilder)
- TypeScript: [`PatchBuilder`](/nl/sdk/typescript/sandbox#patchbuilder)
- Python: [`Patch`](/nl/sdk/python/sandbox#patch) (factory) and [`PatchConfig`](/nl/sdk/python/sandbox#patchconfig) (the value type)
