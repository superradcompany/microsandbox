---
title: "Secrets"
description: "Voeg secrets toe aan sandboxes zonder ze aan de gast bloot te stellen"
icon: "key"
---
...
See the SDK Reference for the full API: [Rust](/nl/sdk/rust/secrets) | [TypeScript](/nl/sdk/typescript/secrets) | [Python](/nl/sdk/python/secrets).
