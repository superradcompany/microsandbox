---
title: "Logs"
description: "Sandboxlogs vastleggen en inspecteren"
icon: "scroll"
---
...
See [`msb logs` reference](/nl/cli/sandbox-commands#msb-logs) for the full flag list.
...
SDK callers see this as a typed [`BootStart` error](/nl/sdk/errors#sandbox-start-failures) — match on it to recover or report cleanly.
