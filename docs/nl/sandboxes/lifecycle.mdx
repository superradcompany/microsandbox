---
title: "Levenscyclus"
description: "Sandboxstatus aanmaken, starten, stoppen en beheren"
icon: "rotate"
---
...
The user-facing surface for these is [`msb logs`](/nl/cli/sandbox-commands#msb-logs) and the SDK [`logs()`](/nl/sandboxes/logs) method — both work on running and stopped sandboxes alike. See the [Logs](/nl/sandboxes/logs) page for the capture model, source semantics, and diagnostic flows.
