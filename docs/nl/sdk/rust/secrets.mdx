---
title: "Secrets"
description: "Secrets-API-referentie"
icon: "key"
---


See [Secrets](/nl/sandboxes/secrets) for how placeholder substitution works and usage examples.
...
Configured via [`NetworkBuilder::on_secret_violation()`](/nl/sdk/rust/networking#on_secret_violation). Determines what happens when the guest sends a request containing a secret placeholder to a host that is **not** in the secret's allow list.
