---
title: "May 1, 2026: disk-image volumes and DNS policy"
description: "TypeScript SDK and network policy redesigns, qcow2 and raw disk-image volume mounts, DNS interception over TCP/53 and DoT, and the new msb command alias."
icon: "bolt"
---
