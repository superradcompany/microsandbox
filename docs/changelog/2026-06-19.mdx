...
```python
from microsandbox import BackendKind, PythonSandbox, set_default_backend

set_default_backend(BackendKind.CLOUD, profile="prod")
...
See the [secrets guide](/security/secrets).
