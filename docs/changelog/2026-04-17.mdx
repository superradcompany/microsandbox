---
title: "April 17, 2026: Python SDK and Docker images"
description: "Initial Python SDK release, Docker image publishing, interactive msb commands, an upstream CA trust config, and concurrency fixes for the TLS MITM proxy."
icon: "bolt"
---
