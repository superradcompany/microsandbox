---
title: "Snapshot"
description: "Referensi API snapshot"
icon: "camera"
---


Disk-only snapshots of a stopped sandbox. See [Snapshots](/id/sandboxes/snapshots) for concepts and walkthroughs; this page is the Rust SDK reference.
...
Boot a fresh sandbox from a snapshot artifact. Mutually exclusive with [`image()`](/id/sdk/rust/sandbox#image) and [`image_with()`](/id/sdk/rust/sandbox#image-with) — the snapshot already pins the image.
