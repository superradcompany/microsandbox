---
title: "Mulai cepat"
description: "Jalankan sandbox dalam waktu kurang dari 5 menit"
icon: "bolt"
---
...
- [Understand sandbox configuration](/id/sandboxes/overview): how the VM, filesystem, and networking fit together
- [Run commands and stream output](/id/sandboxes/commands): `exec`, `shell`, `attach`, and streaming
- [Control network access](/id/networking/overview): policies, DNS interception, and secret protection
- [Manage sandboxes with the CLI](/id/cli/overview): create, inspect, and manage sandboxes from the terminal
