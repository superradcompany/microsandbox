---
title: "Docker"
description: "Jalankan kontainer Docker di dalam microsandbox"
icon: "box"
---


<Tip>
  For production use, we recommend [installing microsandbox natively](/id/getting-started/quickstart).
</Tip>
