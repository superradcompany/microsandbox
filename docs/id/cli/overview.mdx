---
title: "Ikhtisar"
description: "Antarmuka baris perintah msb"
icon: "book"
---
...
For detailed command reference, see [Sandbox Commands](/id/cli/sandbox-commands), [Volume Commands](/id/cli/volume-commands), and [Image Commands](/id/cli/image-commands).
