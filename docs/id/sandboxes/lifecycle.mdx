---
title: "Siklus hidup"
description: "Buat, mulai, hentikan, dan kelola status sandbox"
icon: "rotate"
---
...
The user-facing surface for these is [`msb logs`](/id/cli/sandbox-commands#msb-logs) and the SDK [`logs()`](/id/sandboxes/logs) method — both work on running and stopped sandboxes alike. See the [Logs](/id/sandboxes/logs) page for the capture model, source semantics, and diagnostic flows.
