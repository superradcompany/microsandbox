---
title: "Log"
description: "Tangkap dan periksa log sandbox"
icon: "scroll"
---
...
See [`msb logs` reference](/id/cli/sandbox-commands#msb-logs) for the full flag list.
...
SDK callers see this as a typed [`BootStart` error](/id/sdk/errors#sandbox-start-failures) — match on it to recover or report cleanly.
