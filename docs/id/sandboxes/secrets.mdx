---
title: "Rahasia"
description: "Suntikkan rahasia ke sandbox tanpa mengeksposnya ke guest"
icon: "key"
---
...
See the SDK Reference for the full API: [Rust](/id/sdk/rust/secrets) | [TypeScript](/id/sdk/typescript/secrets) | [Python](/id/sdk/python/secrets).
