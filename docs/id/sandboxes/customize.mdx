---
title: "Sesuaikan"
description: "Sesuaikan lingkungan guest dengan skrip dan patch"
...
- Rust: [`PatchBuilder`](/id/sdk/rust/sandbox#patchbuilder)
- TypeScript: [`PatchBuilder`](/id/sdk/typescript/sandbox#patchbuilder)
- Python: [`Patch`](/id/sdk/python/sandbox#patch) (factory) and [`PatchConfig`](/id/sdk/python/sandbox#patchconfig) (the value type)
