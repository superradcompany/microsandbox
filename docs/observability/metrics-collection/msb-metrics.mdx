...
<CardGroup cols={2}>
  <Card title="Grafana Cloud" icon="cloud" href="/observability/metrics-collection/grafana-cloud">
    Direct OTLP to Grafana Cloud's gateway.
  </Card>
  <Card title="Grafana Alloy" icon="route" href="/observability/metrics-collection/grafana-alloy">
    Local Alloy as a forwarder. Recommended for production.
  </Card>
  <Card title="otel-collector" icon="laptop-code" href="/observability/metrics-collection/otel-collector">
    Local development with the OpenTelemetry Collector.
  </Card>
  <Card title="Datadog" icon="dog" href="/observability/metrics-collection/datadog">
