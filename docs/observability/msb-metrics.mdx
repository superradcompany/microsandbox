...
End-to-end setup walkthroughs live under [Recipes](/examples):
...
<CardGroup cols={2}>
  ...
  <Card title="otel-collector" icon="terminal" href="/examples/metrics-backends/otel-collector">
...
[Labels](/sandboxes/labels) you set on a sandbox ride along to your backend as
metric attributes, so you can build per-user, per-tenant, or per-environment
