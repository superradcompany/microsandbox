...
| Where | Requirement |
|---|---|
| **Linux** | A glibc-based distribution with KVM |
| **macOS** | An Apple Silicon Mac |
| **Windows** | Windows 11 with Windows Hypervisor Platform |
| **[Cloud](/cloud/overview)** | Any host; no local virtualization required |
