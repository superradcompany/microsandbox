...
<Steps>
  <Step title="Install microsandbox">
    ...
    Reboot if Windows asks. `HypervisorPlatform` exposes the WHP API used by libkrun; it is separate from `VirtualMachinePlatform`, which Docker Desktop and WSL2 commonly enable.
  </Step>
