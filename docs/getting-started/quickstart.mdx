...
| Where | Requirement |
|---|---|
| <Icon icon="linux" size={16} /> **Linux** | A glibc-based distribution with KVM |
| <Icon icon="apple" size={16} /> **macOS** | An Apple Silicon Mac |
| <Icon icon="windows" size={16} /> **Windows** | Windows 11 with Windows Hypervisor Platform |
| <Icon icon="cloud" size={16} /> **[Cloud](/cloud/overview)** | Any host; no local virtualization required |
