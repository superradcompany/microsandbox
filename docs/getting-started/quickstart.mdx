...
- [SDK references](/sdk/overview#reference): choose TypeScript, Rust, Python, Go, or Ruby for sandbox lifecycle and API details
- [Protect API credentials](/sandboxes/secrets): let sandboxed code use an API without receiving the credential value
