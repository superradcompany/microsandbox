---
title: Microsandbox quickstart in under five minutes
description: Install microsandbox, then create your first isolated VM and run a command inside it. A practical end-to-end walkthrough using the CLI and SDK.
icon: "bolt"
---
