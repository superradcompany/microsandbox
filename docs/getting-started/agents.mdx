---
title: Run AI agent code safely in microsandbox VMs
description: Give LLM agents an isolated VM to write, execute, and inspect code. Microsandbox is a secure runtime for tool use, code interpreters, and autonomous tasks.
icon: "robot"
---
