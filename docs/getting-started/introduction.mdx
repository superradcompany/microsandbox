---
title: "What is microsandbox? An embeddable VM runtime"
description: "Microsandbox runs untrusted code inside lightweight microVMs with hardware isolation, fast cold starts, and an embeddable SDK for Rust, TypeScript, and Python."
icon: "house"
---
