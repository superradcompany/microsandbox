---
title: "ローカルイメージ"
description: "ローカルコンテナイメージを構築して使用する"
icon: "boxes-stacked"
---
...
<Tip>
  For persistent configuration that applies to all CLI and SDK operations, add the registry to `~/.microsandbox/config.json` instead. See [Registry TLS](/ja/images/overview#registry-tls).
</Tip>
