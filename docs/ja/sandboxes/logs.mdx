---
title: "ログ"
description: "サンドボックスのログをキャプチャして検査する"
icon: "scroll"
---
...
See [`msb logs` reference](/ja/cli/sandbox-commands#msb-logs) for the full flag list.
...
SDK callers see this as a typed [`BootStart` error](/ja/sdk/errors#sandbox-start-failures) — match on it to recover or report cleanly.
