---
title: "シークレット"
description: "ゲストに公開せずにサンドボックスにシークレットを注入する"
icon: "key"
---
...
See the SDK Reference for the full API: [Rust](/ja/sdk/rust/secrets) | [TypeScript](/ja/sdk/typescript/secrets) | [Python](/ja/sdk/python/secrets).
