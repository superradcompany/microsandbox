---
title: "ファイルシステム"
description: "サンドボックス内のファイルを読み書きする"
icon: "folder-open"
---
...
<Tip>
  If you need to transfer many files at once, consider using a [bind-mounted volume](/ja/sandboxes/volumes) instead. Volumes give the guest direct filesystem access, whereas the filesystem API transfers each file individually. For bulk operations, volumes are significantly faster.
</Tip>
