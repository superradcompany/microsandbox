---
title: "ライフサイクル"
description: "サンドボックスの状態を作成、開始、停止、管理する"
icon: "rotate"
---
...
The user-facing surface for these is [`msb logs`](/ja/cli/sandbox-commands#msb-logs) and the SDK [`logs()`](/ja/sandboxes/logs) method — both work on running and stopped sandboxes alike. See the [Logs](/ja/sandboxes/logs) page for the capture model, source semantics, and diagnostic flows.
