---
title: "カスタマイズ"
description: "スクリプトとパッチでゲスト環境をカスタマイズする"
...
- Rust: [`PatchBuilder`](/ja/sdk/rust/sandbox#patchbuilder)
- TypeScript: [`PatchBuilder`](/ja/sdk/typescript/sandbox#patchbuilder)
- Python: [`Patch`](/ja/sdk/python/sandbox#patch) (factory) and [`PatchConfig`](/ja/sdk/python/sandbox#patchconfig) (the value type)
