---
title: "サンドボックスコマンド"
description: "ターミナルからサンドボックスを管理する"
icon: "cube"
---
...
| `--init` | Hand off PID 1 to this init binary (absolute path) inside the guest after agentd's setup. See [Custom init system](/ja/sandboxes/customize#custom-init-system) |
