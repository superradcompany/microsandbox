...
- [Understand sandbox configuration](/ja/sandboxes/overview): how the VM, filesystem, and networking fit together
- [Run commands and stream output](/ja/sandboxes/commands): `exec`, `shell`, `attach`, and streaming
- [Control network access](/ja/networking/overview): policies, DNS interception, and secret protection
- [Manage sandboxes with the CLI](/ja/cli/overview): create, inspect, and manage sandboxes from the terminal
