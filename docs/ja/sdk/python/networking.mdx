...
| `"loopback"` | Loopback addresses (`127.0.0.0/8`, `::1`); the **guest's own** loopback, not the host. See the [loopback-vs-host watch-out](/ja/networking/overview#loopback-vs-host-a-common-trap) |
