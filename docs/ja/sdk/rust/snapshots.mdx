---
title: "スナップショット"
description: "スナップショット API リファレンス"
icon: "camera"
---


Disk-only snapshots of a stopped sandbox. See [Snapshots](/ja/sandboxes/snapshots) for concepts and walkthroughs; this page is the Rust SDK reference.
...
Boot a fresh sandbox from a snapshot artifact. Mutually exclusive with [`image()`](/ja/sdk/rust/sandbox#image) and [`image_with()`](/ja/sdk/rust/sandbox#image-with) — the snapshot already pins the image.
