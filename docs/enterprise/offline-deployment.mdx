...
Install application dependencies before disconnecting. Setup helpers can download missing or mismatched runtime files; use [resolve](/sdk/setup#resolve-check-install-and-ensure) to require an existing installation without downloading.
