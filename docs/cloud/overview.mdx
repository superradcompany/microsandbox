...
| Snapshots | **Limited on cloud** | Create and restore disk snapshots of stopped or crashed sandboxes. Live capture, full checkpoints, branching, groups, and local artifact archives remain local-only. |
