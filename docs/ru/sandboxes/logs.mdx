---
title: "Логи"
description: "Захват и проверка логов песочницы"
icon: "scroll"
---
...
See [`msb logs` reference](/ru/cli/sandbox-commands#msb-logs) for the full flag list.
...
SDK callers see this as a typed [`BootStart` error](/ru/sdk/errors#sandbox-start-failures) — match on it to recover or report cleanly.
