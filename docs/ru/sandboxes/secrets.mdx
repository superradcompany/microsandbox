---
title: "Секреты"
description: "Внедряйте секреты в песочницы, не раскрывая их гостю"
icon: "key"
---
...
See the SDK Reference for the full API: [Rust](/ru/sdk/rust/secrets) | [TypeScript](/ru/sdk/typescript/secrets) | [Python](/ru/sdk/python/secrets).
