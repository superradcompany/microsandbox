...
description: "Создание, запуск, остановка и управление состоянием песочницы"
icon: "rotate"
---
...
The user-facing surface for these is [`msb logs`](/ru/cli/sandbox-commands#msb-logs) and the SDK [`logs()`](/ru/sandboxes/logs) method — both work on running and stopped sandboxes alike. See the [Logs](/ru/sandboxes/logs) page for the capture model, source semantics, and diagnostic flows.
