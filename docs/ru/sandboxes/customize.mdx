---
title: "Настройка"
description: "Настройте гостевую среду с помощью скриптов и патчей"
...
- Rust: [`PatchBuilder`](/ru/sdk/rust/sandbox#patchbuilder)
- TypeScript: [`PatchBuilder`](/ru/sdk/typescript/sandbox#patchbuilder)
- Python: [`Patch`](/ru/sdk/python/sandbox#patch) (factory) and [`PatchConfig`](/ru/sdk/python/sandbox#patchconfig) (the value type)
