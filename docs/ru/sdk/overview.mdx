---
title: "Обзор"
description: "Начните работу с SDK microsandbox"
icon: "play"
---
...
The SDK reference is split by language - choose [Rust SDK](/ru/sdk/rust/sandbox), [TypeScript SDK](/ru/sdk/typescript/sandbox), or [Python SDK](/ru/sdk/python/sandbox) for the full API. See also [error handling](/ru/sdk/errors).
