---
title: "Снимки"
description: "Справочник API снимков"
icon: "camera"
---


Disk-only snapshots of a stopped sandbox. See [Snapshots](/ru/sandboxes/snapshots) for concepts and walkthroughs; this page is the Rust SDK reference.
...
Boot a fresh sandbox from a snapshot artifact. Mutually exclusive with [`image()`](/ru/sdk/rust/sandbox#image) and [`image_with()`](/ru/sdk/rust/sandbox#image-with) — the snapshot already pins the image.
