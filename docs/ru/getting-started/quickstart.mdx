---
title: "Быстрый старт"
description: "Запустите песочницу менее чем за 5 минут"
icon: "bolt"
---
...
- [Understand sandbox configuration](/ru/sandboxes/overview): how the VM, filesystem, and networking fit together
- [Run commands and stream output](/ru/sandboxes/commands): `exec`, `shell`, `attach`, and streaming
- [Control network access](/ru/networking/overview): policies, DNS interception, and secret protection
- [Manage sandboxes with the CLI](/ru/cli/overview): create, inspect, and manage sandboxes from the terminal
