---
title: "Обзор"
description: "Интерфейс командной строки msb"
icon: "book"
---
...
For detailed command reference, see [Sandbox Commands](/ru/cli/sandbox-commands), [Volume Commands](/ru/cli/volume-commands), and [Image Commands](/ru/cli/image-commands).
