---
title: "Команды песочницы"
description: "Управление песочницами из терминала"
icon: "cube"
---
...
| `--init` | Hand off PID 1 to this init binary (absolute path) inside the guest after agentd's setup. See [Custom init system](/ru/sandboxes/customize#custom-init-system) |
