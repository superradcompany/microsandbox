---
title: "Локальные образы"
description: "Создание и использование локальных образов контейнеров"
icon: "boxes-stacked"
---
...
<Tip>
  For persistent configuration that applies to all CLI and SDK operations, add the registry to `~/.microsandbox/config.json` instead. See [Registry TLS](/ru/images/overview#registry-tls).
</Tip>
