---
title: "Snapshots"
description: "Referência da API de snapshots"
icon: "camera"
---


Disk-only snapshots of a stopped sandbox. See [Snapshots](/pt/sandboxes/snapshots) for concepts and walkthroughs; this page is the Rust SDK reference.
...
Boot a fresh sandbox from a snapshot artifact. Mutually exclusive with [`image()`](/pt/sdk/rust/sandbox#image) and [`image_with()`](/pt/sdk/rust/sandbox#image-with) — the snapshot already pins the image.
