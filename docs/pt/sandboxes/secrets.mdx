---
title: "Segredos"
description: "Injete segredos em sandboxes sem expô-los ao convidado"
icon: "key"
---
...
See the SDK Reference for the full API: [Rust](/pt/sdk/rust/secrets) | [TypeScript](/pt/sdk/typescript/secrets) | [Python](/pt/sdk/python/secrets).
