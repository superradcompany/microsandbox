---
title: "Personalizar"
description: "Personalize o ambiente convidado com scripts e patches"
...
- Rust: [`PatchBuilder`](/pt/sdk/rust/sandbox#patchbuilder)
- TypeScript: [`PatchBuilder`](/pt/sdk/typescript/sandbox#patchbuilder)
- Python: [`Patch`](/pt/sdk/python/sandbox#patch) (factory) and [`PatchConfig`](/pt/sdk/python/sandbox#patchconfig) (the value type)
