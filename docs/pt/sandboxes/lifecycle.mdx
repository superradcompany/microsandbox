---
title: "Ciclo de vida"
description: "Criar, iniciar, parar e gerenciar o estado do sandbox"
icon: "rotate"
---
...
The user-facing surface for these is [`msb logs`](/pt/cli/sandbox-commands#msb-logs) and the SDK [`logs()`](/pt/sandboxes/logs) method — both work on running and stopped sandboxes alike. See the [Logs](/pt/sandboxes/logs) page for the capture model, source semantics, and diagnostic flows.
