---
title: "Visão geral"
description: "A interface de linha de comando msb"
icon: "book"
---
...
For detailed command reference, see [Sandbox Commands](/pt/cli/sandbox-commands), [Volume Commands](/pt/cli/volume-commands), and [Image Commands](/pt/cli/image-commands).
