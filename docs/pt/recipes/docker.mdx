---
title: "Docker"
description: "Execute contêineres Docker dentro do microsandbox"
icon: "box"
---


<Tip>
  For production use, we recommend [installing microsandbox natively](/pt/getting-started/quickstart).
</Tip>
