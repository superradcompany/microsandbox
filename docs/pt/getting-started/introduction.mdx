---
title: "Introdução"
description: "Cada agente merece o seu próprio computador"
icon: "house"
---
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="bolt" href="/pt/getting-started/quickstart">
    Get a sandbox running in under 5 minutes
  </Card>

  <Card title="Sandbox overview" icon="box" href="/pt/sandboxes/overview">
    Configuration, rootfs sources, and lifecycle
  </Card>

  <Card title="CLI reference" icon="square-terminal" href="/pt/cli/overview">
    Manage sandboxes from the terminal
  </Card>

  <Card title="SDK reference" icon="code" href="/pt/sdk/rust">
