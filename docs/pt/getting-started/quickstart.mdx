---
title: "Início rápido"
description: "Coloque um sandbox em execução em menos de 5 minutos"
icon: "bolt"
---
...
- [Understand sandbox configuration](/pt/sandboxes/overview): how the VM, filesystem, and networking fit together
- [Run commands and stream output](/pt/sandboxes/commands): `exec`, `shell`, `attach`, and streaming
- [Control network access](/pt/networking/overview): policies, DNS interception, and secret protection
- [Manage sandboxes with the CLI](/pt/cli/overview): create, inspect, and manage sandboxes from the terminal
