---
title: Network security model and threat boundaries
description: Threat model for the microsandbox network stack. What the host-side proxy, DNS interception, and TLS proxy defend against, and what is out of scope.
icon: "shield-halved"
---
