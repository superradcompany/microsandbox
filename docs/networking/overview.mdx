---
title: "Sandbox networking: egress policy and isolation"
description: How the host-controlled network stack enforces egress and ingress rules, blocks private and metadata IPs by default, and lets you write custom policies.
icon: "network-wired"
---
