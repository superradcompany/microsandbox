---
title: DNS resolution and policy enforcement in sandboxes
description: How microsandbox intercepts DNS over UDP/53, TCP/53, and DoT/853 to enforce egress policies, deny domain rules, and the host.microsandbox.internal record.
