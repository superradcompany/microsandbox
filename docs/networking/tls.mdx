...
- [Outbound proxy](/networking/outbound-proxy) explains routing outbound TCP through an external SOCKS proxy, including the CA trust required for HTTPS inspection.
