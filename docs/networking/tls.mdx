---
title: TLS interception and HTTPS inspection (MITM proxy)
description: Inspect, log, and rewrite HTTPS traffic from sandboxes using a built-in MITM proxy with an auto-generated CA. Configure secret substitution and host CA trust.
icon: "lock"
---
