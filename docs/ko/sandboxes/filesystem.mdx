---
title: "파일 시스템"
description: "샌드박스 내부에서 파일을 읽고 씁니다"
icon: "folder-open"
---
...
<Tip>
  If you need to transfer many files at once, consider using a [bind-mounted volume](/ko/sandboxes/volumes) instead. Volumes give the guest direct filesystem access, whereas the filesystem API transfers each file individually. For bulk operations, volumes are significantly faster.
</Tip>
