---
title: "시크릿"
description: "게스트에 노출하지 않고 샌드박스에 시크릿을 주입합니다"
icon: "key"
---
...
See the SDK Reference for the full API: [Rust](/ko/sdk/rust/secrets) | [TypeScript](/ko/sdk/typescript/secrets) | [Python](/ko/sdk/python/secrets).
