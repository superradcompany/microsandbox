---
title: "사용자 지정"
description: "스크립트 및 패치로 게스트 환경을 사용자 지정합니다"
...
- Rust: [`PatchBuilder`](/ko/sdk/rust/sandbox#patchbuilder)
- TypeScript: [`PatchBuilder`](/ko/sdk/typescript/sandbox#patchbuilder)
- Python: [`Patch`](/ko/sdk/python/sandbox#patch) (factory) and [`PatchConfig`](/ko/sdk/python/sandbox#patchconfig) (the value type)
