---
title: "라이프사이클"
description: "샌드박스 상태 생성, 시작, 중지 및 관리"
icon: "rotate"
---
...
The user-facing surface for these is [`msb logs`](/ko/cli/sandbox-commands#msb-logs) and the SDK [`logs()`](/ko/sandboxes/logs) method — both work on running and stopped sandboxes alike. See the [Logs](/ko/sandboxes/logs) page for the capture model, source semantics, and diagnostic flows.
