---
title: "로그"
description: "샌드박스 로그를 캡처하고 검사합니다"
icon: "scroll"
---
...
See [`msb logs` reference](/ko/cli/sandbox-commands#msb-logs) for the full flag list.
...
SDK callers see this as a typed [`BootStart` error](/ko/sdk/errors#sandbox-start-failures) — match on it to recover or report cleanly.
