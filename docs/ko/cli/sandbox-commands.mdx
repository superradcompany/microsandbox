...
| `--init` | Hand off PID 1 to this init binary (absolute path) inside the guest after agentd's setup. See [Custom init system](/ko/sandboxes/customize#custom-init-system) |
