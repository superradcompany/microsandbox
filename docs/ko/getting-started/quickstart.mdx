---
title: "빠른 시작"
description: "5분 이내에 샌드박스를 실행하세요"
icon: "bolt"
---
...
- [Understand sandbox configuration](/ko/sandboxes/overview): how the VM, filesystem, and networking fit together
- [Run commands and stream output](/ko/sandboxes/commands): `exec`, `shell`, `attach`, and streaming
- [Control network access](/ko/networking/overview): policies, DNS interception, and secret protection
- [Manage sandboxes with the CLI](/ko/cli/overview): create, inspect, and manage sandboxes from the terminal
