---
title: "소개"
description: "모든 에이전트는 자신만의 컴퓨터를 가질 자격이 있습니다"
icon: "house"
---
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="bolt" href="/ko/getting-started/quickstart">
    Get a sandbox running in under 5 minutes
  </Card>

  <Card title="Sandbox overview" icon="box" href="/ko/sandboxes/overview">
    Configuration, rootfs sources, and lifecycle
  </Card>

  <Card title="CLI reference" icon="square-terminal" href="/ko/cli/overview">
    Manage sandboxes from the terminal
  </Card>

  <Card title="SDK reference" icon="code" href="/ko/sdk/rust">
