---
title: "스냅샷"
description: "스냅샷 API 레퍼런스"
icon: "camera"
---


Disk-only snapshots of a stopped sandbox. See [Snapshots](/ko/sandboxes/snapshots) for concepts and walkthroughs; this page is the Rust SDK reference.
...
Boot a fresh sandbox from a snapshot artifact. Mutually exclusive with [`image()`](/ko/sdk/rust/sandbox#image) and [`image_with()`](/ko/sdk/rust/sandbox#image-with) — the snapshot already pins the image.
