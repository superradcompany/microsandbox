---
title: "시크릿"
description: "시크릿 API 레퍼런스"
icon: "key"
---


See [Secrets](/ko/sandboxes/secrets) for how placeholder substitution works and usage examples.
...
Configured via [`NetworkBuilder::on_secret_violation()`](/ko/sdk/rust/networking#on_secret_violation). Determines what happens when the guest sends a request containing a secret placeholder to a host that is **not** in the secret's allow list.
