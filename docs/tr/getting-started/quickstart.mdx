...
description: "5 dakikadan kısa sürede bir sandbox çalıştırın"
icon: "bolt"
---
...
- [Understand sandbox configuration](/tr/sandboxes/overview): how the VM, filesystem, and networking fit together
- [Run commands and stream output](/tr/sandboxes/commands): `exec`, `shell`, `attach`, and streaming
- [Control network access](/tr/networking/overview): policies, DNS interception, and secret protection
- [Manage sandboxes with the CLI](/tr/cli/overview): create, inspect, and manage sandboxes from the terminal
