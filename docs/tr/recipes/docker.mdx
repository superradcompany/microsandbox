---
title: "Docker"
description: "microsandbox içinde Docker konteynerlerini çalıştırın"
icon: "box"
---


<Tip>
  For production use, we recommend [installing microsandbox natively](/tr/getting-started/quickstart).
</Tip>
