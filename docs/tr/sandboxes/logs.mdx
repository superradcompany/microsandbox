---
title: "Loglar"
description: "Sandbox loglarını yakalayın ve inceleyin"
icon: "scroll"
---
...
See [`msb logs` reference](/tr/cli/sandbox-commands#msb-logs) for the full flag list.
...
SDK callers see this as a typed [`BootStart` error](/tr/sdk/errors#sandbox-start-failures) — match on it to recover or report cleanly.
