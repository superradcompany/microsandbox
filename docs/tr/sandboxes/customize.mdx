---
title: "Özelleştir"
description: "Misafir ortamını betikler ve yamalarla özelleştirin"
...
- Rust: [`PatchBuilder`](/tr/sdk/rust/sandbox#patchbuilder)
- TypeScript: [`PatchBuilder`](/tr/sdk/typescript/sandbox#patchbuilder)
- Python: [`Patch`](/tr/sdk/python/sandbox#patch) (factory) and [`PatchConfig`](/tr/sdk/python/sandbox#patchconfig) (the value type)
