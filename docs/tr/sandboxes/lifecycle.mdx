---
title: "Yaşam döngüsü"
description: "Sandbox durumunu oluşturun, başlatın, durdurun ve yönetin"
icon: "rotate"
---
...
The user-facing surface for these is [`msb logs`](/tr/cli/sandbox-commands#msb-logs) and the SDK [`logs()`](/tr/sandboxes/logs) method — both work on running and stopped sandboxes alike. See the [Logs](/tr/sandboxes/logs) page for the capture model, source semantics, and diagnostic flows.
