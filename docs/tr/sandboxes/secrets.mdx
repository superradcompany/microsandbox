---
title: "Sırlar"
description: "Misafire ifşa etmeden sandbox'lara sır enjekte edin"
icon: "key"
---
...
See the SDK Reference for the full API: [Rust](/tr/sdk/rust/secrets) | [TypeScript](/tr/sdk/typescript/secrets) | [Python](/tr/sdk/python/secrets).
