...
description: "Anlık görüntüler API referansı"
icon: "camera"
---


Disk-only snapshots of a stopped sandbox. See [Snapshots](/tr/sandboxes/snapshots) for concepts and walkthroughs; this page is the Rust SDK reference.
...
Boot a fresh sandbox from a snapshot artifact. Mutually exclusive with [`image()`](/tr/sdk/rust/sandbox#image) and [`image_with()`](/tr/sdk/rust/sandbox#image-with) — the snapshot already pins the image.
