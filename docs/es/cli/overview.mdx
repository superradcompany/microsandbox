...
description: "La interfaz de línea de comandos msb"
icon: "book"
---
...
For detailed command reference, see [Sandbox Commands](/es/cli/sandbox-commands), [Volume Commands](/es/cli/volume-commands), and [Image Commands](/es/cli/image-commands).
