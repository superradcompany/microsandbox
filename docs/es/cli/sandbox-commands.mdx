---
title: "Comandos de sandbox"
description: "Gestiona sandboxes desde la terminal"
icon: "cube"
---
...
| `--init` | Hand off PID 1 to this init binary (absolute path) inside the guest after agentd's setup. See [Custom init system](/es/sandboxes/customize#custom-init-system) |
