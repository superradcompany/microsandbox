...
description: "Construye y usa imágenes de contenedor locales"
icon: "boxes-stacked"
---
...
<Tip>
  For persistent configuration that applies to all CLI and SDK operations, add the registry to `~/.microsandbox/config.json` instead. See [Registry TLS](/es/images/overview#registry-tls).
</Tip>
