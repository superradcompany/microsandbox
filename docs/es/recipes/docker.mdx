---
title: "Docker"
description: "Ejecuta contenedores Docker dentro de microsandbox"
icon: "box"
---


<Tip>
  For production use, we recommend [installing microsandbox natively](/es/getting-started/quickstart).
</Tip>
