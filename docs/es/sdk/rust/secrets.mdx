---
title: "Secretos"
description: "Referencia de API de secretos"
icon: "key"
---


See [Secrets](/es/sandboxes/secrets) for how placeholder substitution works and usage examples.
...
Configured via [`NetworkBuilder::on_secret_violation()`](/es/sdk/rust/networking#on_secret_violation). Determines what happens when the guest sends a request containing a secret placeholder to a host that is **not** in the secret's allow list.
