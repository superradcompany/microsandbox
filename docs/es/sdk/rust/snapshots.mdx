---
title: "Snapshots"
description: "Referencia de API de snapshots"
icon: "camera"
---


Disk-only snapshots of a stopped sandbox. See [Snapshots](/es/sandboxes/snapshots) for concepts and walkthroughs; this page is the Rust SDK reference.
...
Boot a fresh sandbox from a snapshot artifact. Mutually exclusive with [`image()`](/es/sdk/rust/sandbox#image) and [`image_with()`](/es/sdk/rust/sandbox#image-with) — the snapshot already pins the image.
