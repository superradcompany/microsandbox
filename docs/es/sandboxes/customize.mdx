---
title: "Personalizar"
description: "Personaliza el entorno invitado con scripts y parches"
...
- Rust: [`PatchBuilder`](/es/sdk/rust/sandbox#patchbuilder)
- TypeScript: [`PatchBuilder`](/es/sdk/typescript/sandbox#patchbuilder)
- Python: [`Patch`](/es/sdk/python/sandbox#patch) (factory) and [`PatchConfig`](/es/sdk/python/sandbox#patchconfig) (the value type)
