---
title: "Secretos"
description: "Inyecta secretos en los sandboxes sin exponerlos al invitado"
icon: "key"
---
...
See the SDK Reference for the full API: [Rust](/es/sdk/rust/secrets) | [TypeScript](/es/sdk/typescript/secrets) | [Python](/es/sdk/python/secrets).
