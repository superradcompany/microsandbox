---
title: "Ciclo de vida"
description: "Crea, inicia, detén y gestiona el estado del sandbox"
icon: "rotate"
---
...
The user-facing surface for these is [`msb logs`](/es/cli/sandbox-commands#msb-logs) and the SDK [`logs()`](/es/sandboxes/logs) method — both work on running and stopped sandboxes alike. See the [Logs](/es/sandboxes/logs) page for the capture model, source semantics, and diagnostic flows.
