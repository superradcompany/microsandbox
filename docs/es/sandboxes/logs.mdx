---
title: "Logs"
description: "Captura e inspecciona los logs del sandbox"
icon: "scroll"
---
...
See [`msb logs` reference](/es/cli/sandbox-commands#msb-logs) for the full flag list.
...
SDK callers see this as a typed [`BootStart` error](/es/sdk/errors#sandbox-start-failures) — match on it to recover or report cleanly.
