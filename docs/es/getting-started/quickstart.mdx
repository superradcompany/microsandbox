---
title: "Inicio rápido"
description: "Pon en marcha un sandbox en menos de 5 minutos"
icon: "bolt"
---
...
- [Understand sandbox configuration](/es/sandboxes/overview): how the VM, filesystem, and networking fit together
- [Run commands and stream output](/es/sandboxes/commands): `exec`, `shell`, `attach`, and streaming
- [Control network access](/es/networking/overview): policies, DNS interception, and secret protection
- [Manage sandboxes with the CLI](/es/cli/overview): create, inspect, and manage sandboxes from the terminal
