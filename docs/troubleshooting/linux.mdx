...
microsandbox ships against glibc. Use a glibc-based distribution such as Debian, Ubuntu, Fedora, or Arch for the local runtime.

musl-based distributions such as Alpine are not supported as the host environment for local microsandbox sandboxes.
