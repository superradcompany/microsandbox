---
title: "Volume CLI commands: create, list, remove"
description: Reference for msb volume commands. Create, inspect, list, and remove named persistent volumes that survive across sandbox restarts and rebuilds.
icon: "hard-drive"
---
