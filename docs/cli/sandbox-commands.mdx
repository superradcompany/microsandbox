...
| `--conf` | Load a sparse [sandbox configuration](/sandbox-config). Repeatable |
| `--net-conf`, `--resource-conf`, `--runtime-conf`, `--fs-conf`, `--secret-conf`, `--script-conf` | Load an unwrapped, concern-specific [scoped config](/sandbox-config#scoped-config-files). Repeatable |
...
| `--conf` | Load an explicit sparse [sandbox configuration](/sandbox-config). Repeatable |
| `--net-conf`, `--resource-conf`, `--runtime-conf`, `--fs-conf`, `--secret-conf`, `--script-conf` | Load an explicit [scoped config](/sandbox-config#scoped-config-files). Repeatable |
