...
| `--guest-flush` | Guest writeback policy: `auto` (default), `required`, or `skip`; see [advanced guest flushing](/cli/snapshot-commands#guest-filesystem-flush) |
