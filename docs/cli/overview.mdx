---
title: msb CLI overview and command reference
description: Use the msb command-line tool to create, run, and manage microsandbox VMs from the terminal, with auto-detected TTY and interactive flag handling.
icon: "book"
---
