...
Reboot if Windows asks. `HypervisorPlatform` is the WHP API surface used by libkrun and is separate from `VirtualMachinePlatform`, which WSL2 and Docker Desktop often enable.
