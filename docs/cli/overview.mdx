---
title: CLI overview
"og:title": Microsandbox CLI installation and command reference
sidebarTitle: "Overview"
description: Install the microsandbox CLI and manage local or cloud microVM sandboxes from your terminal.
icon: "book"
---
