---
title: "Image CLI commands: pull, list, remove"
description: Reference for msb image commands. Pull, list, inspect, and remove OCI container images from registries to use as the rootfs for microsandbox VMs.
icon: "layer-group"
---
