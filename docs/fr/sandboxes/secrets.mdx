---
title: "Secrets"
description: "Injectez des secrets dans les sandboxes sans les exposer à l'invité"
icon: "key"
---
...
See the SDK Reference for the full API: [Rust](/fr/sdk/rust/secrets) | [TypeScript](/fr/sdk/typescript/secrets) | [Python](/fr/sdk/python/secrets).
