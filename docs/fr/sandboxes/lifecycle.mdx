---
title: "Cycle de vie"
description: "Créer, démarrer, arrêter et gérer l'état du sandbox"
icon: "rotate"
---
...
The user-facing surface for these is [`msb logs`](/fr/cli/sandbox-commands#msb-logs) and the SDK [`logs()`](/fr/sandboxes/logs) method — both work on running and stopped sandboxes alike. See the [Logs](/fr/sandboxes/logs) page for the capture model, source semantics, and diagnostic flows.
