---
title: "Personnaliser"
description: "Personnalisez l'environnement invité avec des scripts et des correctifs"
...
- Rust: [`PatchBuilder`](/fr/sdk/rust/sandbox#patchbuilder)
- TypeScript: [`PatchBuilder`](/fr/sdk/typescript/sandbox#patchbuilder)
- Python: [`Patch`](/fr/sdk/python/sandbox#patch) (factory) and [`PatchConfig`](/fr/sdk/python/sandbox#patchconfig) (the value type)
