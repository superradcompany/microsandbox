---
title: "Logs"
description: "Capturez et inspectez les logs du sandbox"
icon: "scroll"
---
...
See [`msb logs` reference](/fr/cli/sandbox-commands#msb-logs) for the full flag list.
...
SDK callers see this as a typed [`BootStart` error](/fr/sdk/errors#sandbox-start-failures) — match on it to recover or report cleanly.
