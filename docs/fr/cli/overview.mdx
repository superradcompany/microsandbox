...
description: "L'interface en ligne de commande msb"
icon: "book"
---
...
For detailed command reference, see [Sandbox Commands](/fr/cli/sandbox-commands), [Volume Commands](/fr/cli/volume-commands), and [Image Commands](/fr/cli/image-commands).
