---
title: "Commandes sandbox"
description: "Gérer les sandboxes depuis le terminal"
icon: "cube"
---
...
| `--init` | Hand off PID 1 to this init binary (absolute path) inside the guest after agentd's setup. See [Custom init system](/fr/sandboxes/customize#custom-init-system) |
