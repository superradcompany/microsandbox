---
title: "Snapshots"
description: "Référence d'API des snapshots"
icon: "camera"
---


Disk-only snapshots of a stopped sandbox. See [Snapshots](/fr/sandboxes/snapshots) for concepts and walkthroughs; this page is the Rust SDK reference.
...
Boot a fresh sandbox from a snapshot artifact. Mutually exclusive with [`image()`](/fr/sdk/rust/sandbox#image) and [`image_with()`](/fr/sdk/rust/sandbox#image-with) — the snapshot already pins the image.
