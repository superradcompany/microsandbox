---
title: "Introduction"
description: "Chaque agent mérite son propre ordinateur"
icon: "house"
---
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="bolt" href="/fr/getting-started/quickstart">
    Get a sandbox running in under 5 minutes
  </Card>

  <Card title="Sandbox overview" icon="box" href="/fr/sandboxes/overview">
    Configuration, rootfs sources, and lifecycle
  </Card>

  <Card title="CLI reference" icon="square-terminal" href="/fr/cli/overview">
    Manage sandboxes from the terminal
  </Card>

  <Card title="SDK reference" icon="code" href="/fr/sdk/rust">
