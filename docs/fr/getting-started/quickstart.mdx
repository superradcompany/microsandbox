...
description: "Lancez un sandbox en moins de 5 minutes"
icon: "bolt"
---
...
- [Understand sandbox configuration](/fr/sandboxes/overview): how the VM, filesystem, and networking fit together
- [Run commands and stream output](/fr/sandboxes/commands): `exec`, `shell`, `attach`, and streaming
- [Control network access](/fr/networking/overview): policies, DNS interception, and secret protection
- [Manage sandboxes with the CLI](/fr/cli/overview): create, inspect, and manage sandboxes from the terminal
