---
title: OCI container images as microsandbox rootfs
description: Run microsandbox VMs from any Docker, GHCR, or OCI registry image. Configure pulls, authentication, and custom or insecure registries for self-hosted setups.
icon: "layer-group"
---
