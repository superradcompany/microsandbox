---
title: Boot sandboxes from QCOW2, Raw, or VMDK disks
description: Use full disk images instead of OCI rootfs to run pre-baked Linux distributions. Microsandbox supports QCOW2, Raw, and VMDK formats as the boot device.
icon: "compact-disc"
---
