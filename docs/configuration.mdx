---
title: Global config.json reference for microsandbox
description: Configure microsandbox globally through ~/.microsandbox/config.json. Set defaults for image pulls, network policy, registries, and runtime behavior.
icon: "gear"
---
