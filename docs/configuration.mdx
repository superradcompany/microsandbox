...
"og:title": Microsandbox global configuration reference
description: Configure microsandbox defaults for the CLI and SDKs using the shared config.json file.
icon: "gear"
---
