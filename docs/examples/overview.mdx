...
- **Development Environments**: [VS Code](/examples/development/vscode), code-server, JupyterLab, and VNC desktop.
- **CI/CD & Automation**: GitHub Actions runners, PR checks, Compose tests, preview deployments, dependency audits, batch jobs, and warm workers.
