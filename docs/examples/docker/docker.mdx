...
<Tooltip tip="This deploys the local microsandbox runtime and requires a Linux host with KVM; it is not a microsandbox cloud workflow."><span className="msb-badge-local">Local-only <Icon icon="circle-info" size={11} /></span></Tooltip>
