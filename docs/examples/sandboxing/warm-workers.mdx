...
<CodeGroup>
```sh macOS & Linux
msb snap create coding-agent-base \
  --sandbox agent-base \
  --integrity
```
...
```sh
msb snap verify agent-base:coding-agent-base
```
...
<CodeGroup>
```sh macOS & Linux
msb snap restore agent-base:coding-agent-base --name coding-worker-1 \
  --cpus 2 --memory 2G \
...
<CodeGroup>
```sh macOS & Linux
msb snap restore agent-base:coding-agent-base --name coding-worker-2 \
...
```sh
msb snap rm agent-base:coding-agent-base
```
...
```sh
msb snap create coding-agent-base-v2 --sandbox agent-base --integrity
msb snap verify agent-base:coding-agent-base-v2
```
