...
<CodeGroup>
```sh macOS & Linux
msb snap create postgres-before-migration \
...
```sh
msb snap verify migration-base:postgres-before-migration
```
...
<CodeGroup>
```sh macOS & Linux
msb snap restore migration-base:postgres-before-migration --name migration-test \
...
```sh
msb snap rm migration-base:postgres-before-migration
```
