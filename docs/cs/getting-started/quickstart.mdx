---
title: "Rychlý start"
description: "Spusťte sandbox za méně než 5 minut"
icon: "bolt"
---
...
- [Understand sandbox configuration](/cs/sandboxes/overview): how the VM, filesystem, and networking fit together
- [Run commands and stream output](/cs/sandboxes/commands): `exec`, `shell`, `attach`, and streaming
- [Control network access](/cs/networking/overview): policies, DNS interception, and secret protection
- [Manage sandboxes with the CLI](/cs/cli/overview): create, inspect, and manage sandboxes from the terminal
