---
title: "Tajemství"
description: "Vložte tajemství do sandboxů, aniž byste je odhalili hostovi"
icon: "key"
---
...
See the SDK Reference for the full API: [Rust](/cs/sdk/rust/secrets) | [TypeScript](/cs/sdk/typescript/secrets) | [Python](/cs/sdk/python/secrets).
