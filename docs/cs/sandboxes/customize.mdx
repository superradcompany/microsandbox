---
title: "Přizpůsobit"
description: "Přizpůsobte hostované prostředí pomocí skriptů a oprav"
...
- Rust: [`PatchBuilder`](/cs/sdk/rust/sandbox#patchbuilder)
- TypeScript: [`PatchBuilder`](/cs/sdk/typescript/sandbox#patchbuilder)
- Python: [`Patch`](/cs/sdk/python/sandbox#patch) (factory) and [`PatchConfig`](/cs/sdk/python/sandbox#patchconfig) (the value type)
