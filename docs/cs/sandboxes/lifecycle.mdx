...
description: "Vytváření, spouštění, zastavování a správa stavu sandboxu"
icon: "rotate"
---
...
The user-facing surface for these is [`msb logs`](/cs/cli/sandbox-commands#msb-logs) and the SDK [`logs()`](/cs/sandboxes/logs) method — both work on running and stopped sandboxes alike. See the [Logs](/cs/sandboxes/logs) page for the capture model, source semantics, and diagnostic flows.
