---
title: "Logy"
description: "Zachyťte a prozkoumejte logy sandboxu"
icon: "scroll"
---
...
See [`msb logs` reference](/cs/cli/sandbox-commands#msb-logs) for the full flag list.
...
SDK callers see this as a typed [`BootStart` error](/cs/sdk/errors#sandbox-start-failures) — match on it to recover or report cleanly.
