---
title: "Docker"
description: "Spouštějte Docker kontejnery uvnitř microsandboxu"
icon: "box"
---


<Tip>
  For production use, we recommend [installing microsandbox natively](/cs/getting-started/quickstart).
</Tip>
