---
title: "Snímky"
description: "Reference API snímků"
icon: "camera"
---


Disk-only snapshots of a stopped sandbox. See [Snapshots](/cs/sandboxes/snapshots) for concepts and walkthroughs; this page is the Rust SDK reference.
...
Boot a fresh sandbox from a snapshot artifact. Mutually exclusive with [`image()`](/cs/sdk/rust/sandbox#image) and [`image_with()`](/cs/sdk/rust/sandbox#image-with) — the snapshot already pins the image.
