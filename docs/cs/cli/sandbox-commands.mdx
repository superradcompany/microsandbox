---
title: "Příkazy sandboxu"
description: "Spravujte sandboxy z terminálu"
icon: "cube"
---
...
| `--init` | Hand off PID 1 to this init binary (absolute path) inside the guest after agentd's setup. See [Custom init system](/cs/sandboxes/customize#custom-init-system) |
