---
title: "Lokale Images"
description: "Lokale Container-Images erstellen und verwenden"
icon: "boxes-stacked"
---
...
<Tip>
  For persistent configuration that applies to all CLI and SDK operations, add the registry to `~/.microsandbox/config.json` instead. See [Registry TLS](/de/images/overview#registry-tls).
</Tip>
