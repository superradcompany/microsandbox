---
title: "Sandbox-Befehle"
description: "Sandboxes vom Terminal aus verwalten"
icon: "cube"
---
...
| `--init` | Hand off PID 1 to this init binary (absolute path) inside the guest after agentd's setup. See [Custom init system](/de/sandboxes/customize#custom-init-system) |
