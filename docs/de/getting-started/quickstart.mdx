---
title: "Schnellstart"
description: "Bringen Sie eine Sandbox in unter 5 Minuten zum Laufen"
icon: "bolt"
---
...
- [Understand sandbox configuration](/de/sandboxes/overview): how the VM, filesystem, and networking fit together
- [Run commands and stream output](/de/sandboxes/commands): `exec`, `shell`, `attach`, and streaming
- [Control network access](/de/networking/overview): policies, DNS interception, and secret protection
- [Manage sandboxes with the CLI](/de/cli/overview): create, inspect, and manage sandboxes from the terminal
