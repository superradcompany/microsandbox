---
title: "Lebenszyklus"
description: "Sandbox-Zustand erstellen, starten, stoppen und verwalten"
icon: "rotate"
---
...
The user-facing surface for these is [`msb logs`](/de/cli/sandbox-commands#msb-logs) and the SDK [`logs()`](/de/sandboxes/logs) method — both work on running and stopped sandboxes alike. See the [Logs](/de/sandboxes/logs) page for the capture model, source semantics, and diagnostic flows.
