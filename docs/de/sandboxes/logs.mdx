---
title: "Logs"
description: "Sandbox-Logs erfassen und prüfen"
icon: "scroll"
---
...
See [`msb logs` reference](/de/cli/sandbox-commands#msb-logs) for the full flag list.
...
SDK callers see this as a typed [`BootStart` error](/de/sdk/errors#sandbox-start-failures) — match on it to recover or report cleanly.
