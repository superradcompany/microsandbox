---
title: "Geheimnisse"
description: "Geheimnisse in Sandboxes einfügen, ohne sie dem Gast preiszugeben"
icon: "key"
---
...
See the SDK Reference for the full API: [Rust](/de/sdk/rust/secrets) | [TypeScript](/de/sdk/typescript/secrets) | [Python](/de/sdk/python/secrets).
