---
title: "Anpassen"
description: "Passen Sie die Gastumgebung mit Skripten und Patches an"
...
- Rust: [`PatchBuilder`](/de/sdk/rust/sandbox#patchbuilder)
- TypeScript: [`PatchBuilder`](/de/sdk/typescript/sandbox#patchbuilder)
- Python: [`Patch`](/de/sdk/python/sandbox#patch) (factory) and [`PatchConfig`](/de/sdk/python/sandbox#patchconfig) (the value type)
