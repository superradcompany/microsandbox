---
title: "Snapshots"
description: "Snapshots-API-Referenz"
icon: "camera"
---


Disk-only snapshots of a stopped sandbox. See [Snapshots](/de/sandboxes/snapshots) for concepts and walkthroughs; this page is the Rust SDK reference.
...
Boot a fresh sandbox from a snapshot artifact. Mutually exclusive with [`image()`](/de/sdk/rust/sandbox#image) and [`image_with()`](/de/sdk/rust/sandbox#image-with) — the snapshot already pins the image.
