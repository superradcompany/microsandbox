---
title: "Panoramica"
description: "L'interfaccia a riga di comando msb"
icon: "book"
---
...
For detailed command reference, see [Sandbox Commands](/it/cli/sandbox-commands), [Volume Commands](/it/cli/volume-commands), and [Image Commands](/it/cli/image-commands).
