---
title: "Comandi sandbox"
description: "Gestisci le sandbox dal terminale"
icon: "cube"
---
...
| `--init` | Hand off PID 1 to this init binary (absolute path) inside the guest after agentd's setup. See [Custom init system](/it/sandboxes/customize#custom-init-system) |
