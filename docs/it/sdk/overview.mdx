---
title: "Panoramica"
description: "Inizia con gli SDK microsandbox"
icon: "play"
---
...
The SDK reference is split by language - choose [Rust SDK](/it/sdk/rust/sandbox), [TypeScript SDK](/it/sdk/typescript/sandbox), or [Python SDK](/it/sdk/python/sandbox) for the full API. See also [error handling](/it/sdk/errors).
