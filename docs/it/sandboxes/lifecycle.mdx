---
title: "Ciclo di vita"
description: "Crea, avvia, arresta e gestisci lo stato della sandbox"
icon: "rotate"
---
...
The user-facing surface for these is [`msb logs`](/it/cli/sandbox-commands#msb-logs) and the SDK [`logs()`](/it/sandboxes/logs) method — both work on running and stopped sandboxes alike. See the [Logs](/it/sandboxes/logs) page for the capture model, source semantics, and diagnostic flows.
