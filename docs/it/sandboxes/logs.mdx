---
title: "Log"
description: "Cattura e ispeziona i log della sandbox"
icon: "scroll"
---
...
See [`msb logs` reference](/it/cli/sandbox-commands#msb-logs) for the full flag list.
...
SDK callers see this as a typed [`BootStart` error](/it/sdk/errors#sandbox-start-failures) — match on it to recover or report cleanly.
