---
title: "Personalizza"
description: "Personalizza l'ambiente guest con script e patch"
...
- Rust: [`PatchBuilder`](/it/sdk/rust/sandbox#patchbuilder)
- TypeScript: [`PatchBuilder`](/it/sdk/typescript/sandbox#patchbuilder)
- Python: [`Patch`](/it/sdk/python/sandbox#patch) (factory) and [`PatchConfig`](/it/sdk/python/sandbox#patchconfig) (the value type)
