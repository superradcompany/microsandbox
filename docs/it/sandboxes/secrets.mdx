---
title: "Segreti"
description: "Inietta segreti nelle sandbox senza esporli al guest"
icon: "key"
---
...
See the SDK Reference for the full API: [Rust](/it/sdk/rust/secrets) | [TypeScript](/it/sdk/typescript/secrets) | [Python](/it/sdk/python/secrets).
