---
title: "Immagini locali"
description: "Crea e usa immagini container locali"
icon: "boxes-stacked"
---
...
<Tip>
  For persistent configuration that applies to all CLI and SDK operations, add the registry to `~/.microsandbox/config.json` instead. See [Registry TLS](/it/images/overview#registry-tls).
</Tip>
