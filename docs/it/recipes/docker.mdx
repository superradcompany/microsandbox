---
title: "Docker"
description: "Esegui container Docker all'interno di microsandbox"
icon: "box"
---


<Tip>
  For production use, we recommend [installing microsandbox natively](/it/getting-started/quickstart).
</Tip>
