---
title: "Avvio rapido"
description: "Avvia una sandbox in meno di 5 minuti"
icon: "bolt"
---
...
- [Understand sandbox configuration](/it/sandboxes/overview): how the VM, filesystem, and networking fit together
- [Run commands and stream output](/it/sandboxes/commands): `exec`, `shell`, `attach`, and streaming
- [Control network access](/it/networking/overview): policies, DNS interception, and secret protection
- [Manage sandboxes with the CLI](/it/cli/overview): create, inspect, and manage sandboxes from the terminal
