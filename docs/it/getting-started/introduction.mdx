---
title: "Introduzione"
description: "Ogni agente merita il proprio computer"
icon: "house"
---
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="bolt" href="/it/getting-started/quickstart">
    Get a sandbox running in under 5 minutes
  </Card>

  <Card title="Sandbox overview" icon="box" href="/it/sandboxes/overview">
    Configuration, rootfs sources, and lifecycle
  </Card>

  <Card title="CLI reference" icon="square-terminal" href="/it/cli/overview">
    Manage sandboxes from the terminal
  </Card>

  <Card title="SDK reference" icon="code" href="/it/sdk/rust">
