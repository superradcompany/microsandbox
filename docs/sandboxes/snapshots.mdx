---
title: "Sandbox snapshots: save and restore disk state"
description: Capture a stopped sandbox's writable disk layer as a portable artifact, then boot fresh sandboxes from the saved snapshot or share it across machines.
icon: "code-branch"
---
