...
The archive is unpacked into child-owned staging and then discarded from that operation; no intermediate installed snapshot is loaded into `~/.microsandbox/snapshots`.
