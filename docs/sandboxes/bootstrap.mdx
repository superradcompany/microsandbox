...
For exact bootstrap, patch, and init APIs, see [TypeScript](/sdk/typescript/sandbox), [Rust](/sdk/rust/sandbox), [Python](/sdk/python/sandbox), or [Go](/sdk/go/sandbox). For CLI configuration and creation flags, see [Configuration file](/cli/configuration) and [Sandbox commands](/cli/sandbox-commands).
