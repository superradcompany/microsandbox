...
The normal layered root remains the default and retains layer-level deduplication. Flat v1 uses ext4 and is incompatible with rootfs patches and snapshots; unsupported combinations fail explicitly.
