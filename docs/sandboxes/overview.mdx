---
title: "Microsandbox VMs: configuration and concepts"
description: How microsandbox sandboxes work as hardware-isolated microVMs. Learn the security model, default resources, and how to configure CPU, memory, and image.
icon: "circle-info"
---
