...
Secret changes through modify are Rust-SDK and CLI only for now. See [Modify a running sandbox](/sandboxes/lifecycle#modify-a-running-sandbox) for how changes are applied.
