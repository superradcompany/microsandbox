---
title: Inject secrets into sandboxes via TLS proxy
description: Pass credentials and API keys to a sandbox without exposing them to the guest, using placeholder substitution at the TLS proxy and per-host allow lists.
icon: "key"
---
