...
See [Optimization](/sandboxes/optimization#cpu-placement) for workload selection guidance and the interaction with host topology, THP, and interrupt acceleration.
