---
title: Bidirectional events between host and sandbox
description: Send and receive structured events between the host application and a running sandbox guest. Conceptual overview, event types, and the planned API surface.
