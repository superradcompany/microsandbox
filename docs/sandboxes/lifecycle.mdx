---
title: "Sandbox lifecycle: create, start, stop, destroy"
description: Manage the full lifecycle of a microsandbox VM. Create, boot, pause, restart, and destroy sandboxes, plus inspect persisted state across restarts.
icon: "rotate"
---
