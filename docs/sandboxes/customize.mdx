---
title: Customize sandboxes with scripts, init, and rootfs
description: Inject startup scripts, override the init binary, layer files into the rootfs, and pin guest kernels to tailor a microsandbox VM for your workload.
