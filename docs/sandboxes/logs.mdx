---
title: Capture, stream, and diagnose sandbox logs
description: Read guest and host logs, follow them in real time, and persist output to disk. Covers msb logs, log files on disk, and SDK log streaming APIs.
icon: "scroll"
---
