...
<Tooltip tip="Cloud volumes do not expose a caller-host path, but the volume filesystem API works without a running sandbox."><span className="msb-badge-note">On cloud <Icon icon="circle-info" size={11} /></span></Tooltip>
