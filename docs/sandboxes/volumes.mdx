---
title: Persistent volumes for sandbox data sharing
description: Mount named volumes, host directories, individual files, and disk images into a sandbox to persist data and share state between microsandbox VMs.
icon: "hard-drive"
---
