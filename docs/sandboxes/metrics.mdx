---
title: "Sandbox metrics: monitor CPU, memory, and I/O"
description: Sample CPU, memory, disk, and network usage for a running sandbox, or stream metrics continuously through the SDK's metricsStream and CLI inspect commands.
icon: "chart-line"
---
