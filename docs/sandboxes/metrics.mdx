...
<Note>
Need continuous shipping to Grafana, Datadog, Prometheus, or any other OTel-compatible backend? See [`msb-metrics`](/observability/metrics-collection/msb-metrics), a sidecar binary that reads the same data and ships it over OTLP.
</Note>
