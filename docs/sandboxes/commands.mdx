---
title: Run commands and stream output in a sandbox
description: Execute one-shot commands, stream stdout and stderr, attach a TTY, and signal processes inside a microsandbox VM from the SDK or CLI.
icon: "terminal"
---
