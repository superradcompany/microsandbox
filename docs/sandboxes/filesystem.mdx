---
title: Read and write files inside a running sandbox
description: Read, write, list, and stream files inside a microsandbox guest from the host. Covers the SandboxFs API, large file streams, and overlay-aware paths.
icon: "folder-open"
---
