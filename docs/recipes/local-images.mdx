---
title: Use locally built Docker images with microsandbox
description: Run a local Docker registry, push a custom-built image to it, and configure microsandbox to pull from it. A recipe for offline and air-gapped workflows.
icon: "boxes-stacked"
---
