---
title: Deploy microsandbox as a Docker container on Linux
description: Run microsandbox itself inside a Docker container on Linux hosts. Configure KVM passthrough, volume mounts, and the published microsandbox Docker image.
icon: "box"
---
