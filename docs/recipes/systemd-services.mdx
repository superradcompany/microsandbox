---
title: Boot microsandbox guests under systemd as PID 1
description: Configure microsandbox to hand PID 1 to systemd so cgroups, sockets, and unit files work as expected. A recipe for running services that need a real init.
icon: "gear"
---
