...
<Tooltip tip="The agent workflow works on microsandbox cloud; omit replace-on-create from the example command."><span className="msb-badge-limited">Limited on cloud <Icon icon="circle-info" size={11} /></span></Tooltip>
